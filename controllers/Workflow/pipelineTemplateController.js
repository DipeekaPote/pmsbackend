const Pipeline = require('../../models/Workflow/pipelineTemplateModel.js');
...
const createPipeline = async (req, res) => {
    try {
        let newPipeline;
        const { pipelineName, availableto, sortjobsby, accountId, description, duedate, accounttags, priority, assignees, name, startdate, stages, active } = req.body;

        newPipeline = await Pipeline.create({ pipelineName, availableto, sortjobsby, accountId, description, duedate, accounttags, priority, assignees, name, startdate, stages, active });
